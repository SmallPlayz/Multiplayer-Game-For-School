...
class Game extends Thread{
    ...
    Game() {
        ...
        icon = new ImageIcon("images/player3.png");
...
class Gun extends Thread{
    ...
    public void run() {
        ...
        bullet = new JLabel(new ImageIcon("images/bulletWhite.png"));
    ...
    public void run() {
        ...
        if(MultiplayerDir == 'W') {
            for (int i = 0; i < 3000; i++) {
                bullet.setLocation(bullet.getX(), bullet.getY() - 1);
                Game.wait(2);
                if(bullet.getX() <= Game.player3.getX()+100 && bullet.getX() >= Game.player3.getX()-15){
                    if(bullet.getY() <= Game.player3.getY()+100 && bullet.getY() >= Game.player3.getY()-15){
